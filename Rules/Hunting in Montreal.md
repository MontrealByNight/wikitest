...
Human PCs can give a Resonance, but for balancing purpose there are some limits regarding it, otherwise it becomes very easy to exploit:
- The Resonance is chosen by the Human's player. After all, they decide in what mood is their character.
- The temperament is rolled with a /coinflip. If it's head, then the temperament is Fleeting. If it's tail, then it's negligible.
...
An assault-feeder, this Kindred chooses to stalk, overpower, feed and escape from their prey.
- Strength + Brawl (for feeding by force) 
- Wits + Streetwise (for stalking criminals)
...
You can not use this hunting pool to find the blood of a kindred to learn a new discipline.

- Strength + Brawl (beating an opponent)
- Persuasion + Manipulation (seducing a victim)

# Cleaver
This Kindred feeds covertly from a mortal family and friends, often their own.
...
Mostly, they are expected to hunt on their herd to avoid a masquerade breach.

- Manipulation + Persuasion

They can hunt anywhere at DC 5, on a failure it's important to ping the staff.

# Extortionist

This Kindred acquires blood in exchange for services rendered.
...
This Kindred only feeds from animals.
...
Graverobbers often feed from fresh corpses, though they actually prefer feeding from living mourners in cemeteries or mentally agitated visitors and patients in hospitals.

- Resolve + Medicine (for feeding on corpses) 
...
Known as plague-rats, these Kindred feed exclusively on the dying. They find their targets in hospitals, assisted living homes and places where end of life care is provided. Constantly on the lookout for new victims, they often have difficulties settling in one place.
...
- Manipulation + Subterfuge (to flatter) 
- Intimidation + Fame (to bully)

Locations:
They usually mostly hunt their herd and rarely use their cult as an actual hunting ground.
They can hunt in locations where a certain cult is present or where the fans are, DC 4
...
This Kindred prefers to feed from sleeping victims using stealth or Disciplines.
...
The Kindred feeds almost exclusively during (or while feigning) sex, relying on Disciplines, seduction skills, or the appetites of others to conceal their nature.
...
The Kindred builds a trap, in the form of their haven, and lures their prey into it. They might be there for the thrill, for a good time or just to explore, but regardless the trapdoor gets their fill.

- Charisma + Stealth (if your victims enter your killing ground anticipating a fun night)
